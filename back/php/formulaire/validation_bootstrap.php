            ...
            <div class="col-md-8 mt-4">
                ...
                <form action="recap.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="mdp" class="form-control" id="mdp" placeholder="Entrer votre mot de  passe">
                        </div>
                        <div class="form-group">
                            <label for="mdpconfirm">Confirmer votre mot de passe</label>
                            <input type="password" name="mdpconfirm" class="form-control" id="mdpconfirm" placeholder="Verifier votre mot passe">
                        </div>
                        ...
                        <input type="submit" name="envoyer" value="envoyer" class="btn btn-primary">Envoyer
                </form>
            </div>
        </div>
    </div>
